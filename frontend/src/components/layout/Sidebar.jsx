...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:w-64 flex-col bg-[linear-gradient(180deg,#081729_0%,#0b1f38_48%,#111827_100%)] text-slate-100 h-screen sticky top-0" data-testid="sidebar">
      <div className="flex items-center gap-2 px-6 h-16 border-b border-white/10 shrink-0">
        <div className="w-8 h-8 rounded-md bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center shadow-lg shadow-blue-500/20">
